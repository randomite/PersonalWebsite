var skel = function() {
    var e = "config",
        ...
        kt = "normalize",
        Lt = "change",
        At = "applyRowTransforms",
        Ot = "vertical",
        Mt = "_skel_placeholder",
        _t = "collapse",
        Dt = "nextSibling",
        Pt = "forceDefaultState",
        Ht = "html",
        Bt = "querySelectorAll",
        jt = "min-height",
        Ft = "max-height",
        ...
        Gt = {
            ...
            parseMeasurement: function(e) {
                ...
                if (typeof e != "string") t = [e, "px"];
                    ...
                    var n;
                    n = e[k](/([0-9\.]+)([^\s]*)/), n[f] < 3 || !n[2] ? t = [parseFloat(e), "px"] : t = [parseFloat(n[1]), n[2]]
                }
                return t
            },
            canUse: function(e) {
            ...
            applyRowTransforms: function(t) {
                var r, i, o, u = Gt.getLevel(t[e][E][_t]);
                Gt[e].RTL && (Gt.unreverseRows(), u > 0 && Gt.reverseRows(u)), i = "_skel_cell_important_placeholder", r = Gt[s]("skel-cell-important"), r && r[f] > 0 && Gt[n](r, function(t) {
                    ...
                    var n = r[t],
                        ...
                        c;
                    if (!o) return;
                    o[g][k](/no-collapse/) ? c = 101 : o[g][k](/collapse-at-([0-9])/) ? c = parseInt(RegExp.$1) : c = 0;
                    if (u > 0 && c <= u) {
                        if (n[rt](i) && n[i] !== a) return;
                        s = Gt[e].RTL ? Dt : "previousSibling", o = n[s];
                        while (o && o.nodeName == "#text") o = o[s];
                        if (!o) return;
                        n[l][p](n, n[l][vt]), n[i] = o
                    } else n[rt](i) || (n[i] = a), o = n[i], o !== a && (n[l][p](n, o[Dt]), n[i] = a)
                })
            },
            reverseRows: function(e) {
                ...
                Gt[n](t, function(n) {
                    if (n === f) return;
                    var r = t[n];
                    if (r[B] || e > 0 && r[g][k](/\bcollapse-at-([0-9])\b/) && parseInt(RegExp.$1) >= e) return;
                    var i = r.children,
                        s;
            ...
            bind: function(e, t) {
                Gt[V][e] || (Gt[V][e] = []), Gt[V][e][d](t), e == Lt && Gt.isInit && t()
            },
            change: function(e) {
                Gt.bind(Lt, e)
            },
            ...
            registerLocation: function(e, t) {
                e == F ? t[gt] = function(e, t) {
                    t ? this[p](e, this[vt]) : this === Gt.me[l] ? this[p](e, Gt.me) : this.appendChild(e)
                } : t[gt] = function(e, t) {
                    t ? this[p](e, this[vt]) : this.appendChild(e)
                }, Gt[x][e] = t
            },
            ...
            addCachedElementToState: function(e, t) {
                Gt[D][o][e] ? Gt[D][o][e][d](t) : Gt[D][o][e] = [t]
            },
            attachElement: function(e) {
                var t, n = e.location,
                    r = a;
                return e[Nt] ? _ : (n[0] == "^" && (n = n[M](1), r = _), n in Gt[x] ? (t = Gt[x][n], t[gt](e[b], r), e[Nt] = _, e.onAttach && e.onAttach(), _) : a)
            },
            ...
            cacheElement: function(e, t, n, r) {
                return t[l] && t[l].removeChild(t), Gt[D][i][e] = Gt[L](e, t, n, r)
            },
            detachAllElements: function(e) {
                var t, r, s = {};
                Gt[n](e, function(t) {
                    s[e[t].id] = _
                }), Gt[n](Gt[D][i], function(e) {
                    if (e in s) return;
                    Gt.detachElement(e)
                })
            },
            detachElement: function(e) {
                ...
                n[l].removeChild(n), t[Nt] = a, t.onDetach && t.onDetach()
            },
            getCachedElement: function(e) {
                return Gt[D][i][e] ? Gt[D][i][e] : c
            },
            ...
            changeState: function(s) {
                ...
                if (!Gt[D][dt][Gt[r]]) {
                    Gt[D][dt][Gt[r]] = {
                        ...
                        elements: [],
                        values: {}
                    }, c = Gt[D][dt][Gt[r]], Gt[r] === Gt.sd ? u = [] : u = Gt[r][M](1).split(Gt.sd), Gt[X](c[e], Gt[it][S]), Gt[n](u, function(n) {
                        Gt[X](c[e], Gt[t][u[n]][e])
                    }), p = [], b = "mV" + Gt[r], c[e][P].content ? x = c[e][P].content : (c[e][P].scalable === a ? p[d]("user-scalable=no") : p[d]("user-scalable=yes"), c[e][P].width ? p[d]("width=" + c[e][P].width) : p[d](mt), x = p.join(",")), (g = Gt[m](b)) || (g = Gt[H](b, Gt.newMeta(P, x), Z, 4)), c[i][d](g);
                    var C, k;
                    p = Gt[N](c[e][I]), C = p[0], k = p[1], c.values[I] = C + k, b = "iC" + c.values[I];
                    if (!(g = Gt[m](b))) {
                        var L, A, _;
                        L = C * .75 + k, A = C + k, _ = C * 1.25 + k, g = Gt[H](b, Gt[w]("body{min-width:" + A + j + ".container{margin-left:auto;margin-right:auto;width:" + A + j + ".container.small{width:" + L + j + ".container.big{width:100%;max-width:" + _ + ";min-width:" + A + j), F, 3)
                    }
                    c[i][d](g), b = "iGG" + c[e][E][h][Ot] + "_" + c[e][E][h][at];
                    if (!(g = Gt[m](b))) {
                        var B, W, V, $, J, G, Y;
                        p = Gt[N](c[e][E][h][Ot]), B = p[0], W = p[1], V = B + W, $ = B / 2 + W, J = B / 4 + W, G = B * 1.5 + W, Y = B * 2 + W;
                    ...
                    b = "iCd" + Gt[r];
                    if (!(g = Gt[m](b))) {
                        x = [], T = [], Gt[n](Gt[t], function(e) {
                            Gt[R](u, e) !== -1 ? x[d](".not-" + e) : T[d](".only-" + e)
                        });
                        var yt = (x[f] > 0 ? x.join(",") + et : "") + (T[f] > 0 ? T.join(",") + et : "");
                        g = Gt[H](b, Gt[w](yt[U](/\.([0-9])/, Wt)), F, 3), c[i][d](g)
                    }
                    Gt[n](u, function(r) {
                        Gt[t][u[r]][e][Qt] && (b = "ss" + u[r], (g = Gt[m](b)) || (g = Gt[H](b, Gt.newStyleSheet(Gt[t][u[r]][e][Qt]), F, 5)), c[i][d](g)), Gt[t][u[r]][i][f] > 0 && Gt[n](Gt[t][u[r]][i], function(e) {
                            c[i][d](Gt[t][u[r]][i][e])
                        })
                    }), Gt[D][o][Gt[r]] && (Gt[n](Gt[D][o][Gt[r]], function(e) {
                        c[i][d](Gt[D][o][Gt[r]][e])
                    }), Gt[D][o][Gt[r]] = [])
                } else c = Gt[D][dt][Gt[r]];
                Gt.detachAllElements(c[i]), Gt[ut](c[i]), Gt[Q](function() {
                    Gt[At](c)
                }), Gt[q].state = Gt[D][dt][Gt[r]], Gt[q][r] = Gt[r], Gt.trigger(Lt)
            },
            getStateId: function() {
                if (Gt[Pt] && Gt[e].defaultState) return Gt[e].defaultState;
                var r = "";
            ...
            poll: function() {
                var e = "";
                e = Gt.getStateId(), e === "" && (e = Gt.sd), e !== Gt[r] && (Gt[Kt] ? Gt.changeState(e) : (Gt[x][Ht][g] = Gt[x][Ht][g][U](Gt[r][M](1)[U](new RegExp(Gt.sd, "g"), " "), ""), Gt.changeState(e), Gt[x][Ht][g] = Gt[x][Ht][g] + " " + Gt[r][M](1)[U](new RegExp(Gt.sd, "g"), " "), Gt[x][Ht][g].charAt(0) == " " && (Gt[x][Ht][g] = Gt[x][Ht][g][M](1))))
            },
            updateState: function() {
                var e, s, u, a, l = [];
                if (Gt[r] == Gt.sd) return;
                e = Gt[r][M](1).split(Gt.sd), Gt[n](e, function(o) {
                    s = Gt[t][e[o]];
                    if (s[i][f] == 0) return;
                    Gt[n](s[i], function(e) {
                        Gt[D][dt][Gt[r]][i][d](s[i][e]), l[d](s[i][e])
                    })
                }), Gt[D][o][Gt[r]] && (Gt[n](Gt[D][o][Gt[r]], function(e) {
                    Gt[D][dt][Gt[r]][i][d](Gt[D][o][Gt[r]][e]), l[d](Gt[D][o][Gt[r]][e])
                }), Gt[D][o][Gt[r]] = []), l[f] > 0 && Gt[ut](l)
            },
            newDiv: function(e) {
            ...
            newInline: function(e) {
                var t;
                return t = document[C]("style"), t.type = ht, t[qt] = e, t
            },
            ...
            initAPI: function() {
                ...
                Gt[q][ot] = 99, e = "other", r[k](/Firefox/) ? e = "firefox" : r[k](/Chrome/) ? e = "chrome" : r[k](/Safari/) && !r[k](/Chrome/) ? e = "safari" : r[k](/(OPR|Opera)/) ? e = "opera" : r[k](/MSIE ([0-9]+)/) ? (e = "ie", Gt[q][ot] = RegExp.$1) : r[k](/Trident\/.+rv:([0-9]+)/) && (e = "ie", Gt[q][ot] = RegExp.$1), Gt[q].browser = e, Gt[q][A] = "other", t = {
                    ...
                    r[k](new RegExp(t[e], "g")) && (Gt[q][A] = e)
                });
                switch (Gt[q][A]) {
                    case "ios":
                        r[k](/([0-9_]+) like Mac OS X/), e = parseFloat(RegExp.$1[U]("_", ".")[U]("_", ""));
                        break;
                    case Xt:
                        r[k](/Android ([0-9\.]+)/), e = parseFloat(RegExp.$1);
                        break;
                    case "mac":
                        r[k](/Mac OS X ([0-9_]+)/), e = parseFloat(RegExp.$1[U]("_", ".")[U]("_", ""));
                        break;
                    case "wp":
                        r[k](/IEMobile\/([0-9\.]+)/), e = parseFloat(RegExp.$1);
                        break;
                    case "windows":
                        r[k](/Windows NT ([0-9\.]+)/), e = parseFloat(RegExp.$1);
                        break;
                    default:
                        e = 99
                }
                Gt[q].deviceVersion = e, Gt[q].isTouch = Gt[q][A] == "wp" ? navigator.msMaxTouchPoints > 0 : "ontouchstart" in window, Gt[q].isMobile = Gt[q][A] == "wp" || Gt[q][A] == Xt || Gt[q][A] == "ios"
            },
            initConfig: function(r) {
                var s = [],
                    o = [];
                typeof r == b && (r[t] && (Gt[e][t] = {}), Gt[X](Gt[e], r)), E in Gt[e] && h in Gt[e][E] && typeof Gt[e][E][h] != b && (Gt[e][E][h] = {
                    vertical: Gt[e][E][h],
                    horizontal: Gt[e][E][h]
                }), Gt[X](Gt[it][S][E], Gt[e][E]), Gt[it][S][I] = Gt[e][I], Gt[n](Gt[e][t], function(n) {
                    var r, s = {},
                        u, a;
                    Gt[X](s, Gt[e][t][n]), Qt in s || (s[Qt] = Gt[it][S][Qt]), Tt in s || (s[Tt] = Gt[it][S][Tt]), "range" in s && (u = s.range, u == "*" ? a = "" : u.charAt(0) == "-" ? a = "(max-width: " + parseInt(u[M](1)) + "px)" : u.charAt(u[f] - 1) == "-" ? a = Et + parseInt(u[M](0, u[f] - 1)) + "px)" : Gt[R](u, "-") != -1 && (u = u.split("-"), a = Et + parseInt(u[0]) + "px) and (max-width: " + parseInt(u[1]) + "px)"), s[Tt] = a), E in s && h in s[E] && typeof s[E][h] != b && (s[E][h] = {
                        vertical: s[E][h],
                        horizontal: s[E][h]
                ...
                }), "*" in Gt[e][t] && (Gt[Kt] = _, Gt[e][t]["*"][P] = Gt[e][P]), Gt[n](Gt[e][V], function(t) {
                    Gt.bind(t, Gt[e][V][t])
            ...
            initElements: function() {
                var t = [];
                t[d](Gt[L]("mV", Gt.newMeta(P, mt), Z, 1));
                switch (Gt[e].reset) {
                    case "full":
                        t[d](Gt[L]("iR", Gt[w](Gt.css.r), Z, 2));
                        break;
                    case kt:
                        t[d](Gt[L]("iN", Gt[w](Gt.css.n), Z, 2))
                }
            ...
            initEvents: function() {
                var t;
                !Gt[e].pollOnce && !Gt[Kt] && (Gt.bind(wt, function() {
                    Gt.poll()
                }), Gt.bind(T, function() {
                    Gt.poll()
                })), Gt[q][A] == "ios" && Gt[Q](function() {
                    Gt.bind(T, function() {
                        var e = document[u]("input");
                        Gt[n](e, function(t) {
                            e[t][Mt] = e[t][yt], e[t][yt] = ""
                ...
                }), window[Jt] && Gt.bind(wt, window[Jt]), window[Jt] = function() {
                    Gt.trigger(wt)
            ...
            initUtilityMethods: function() {
                document[Y] ? ! function(e, t) {
                    ...
                    return s[Ut] !== c && u < s[Ut] || s[Rt] !== c && u > s[Rt] || s[jt] !== c && l < s[jt] || s[Ft] !== c && l > s[Ft] ? a : _
                })
            },
            preInit: function() {
                var e = document[u]("script");
                Gt.me = e[e[f] - 1], Gt.initUtilityMethods(), Gt.initAPI(), Gt[nt](Ht, document[u](Ht)[0]), Gt[nt](F, document[u](F)[0]), Gt[Q](function() {
                    Gt[nt]("body", document[u]("body")[0])
                }), Gt[q][ot] >= 10 && Gt[lt](Gt[L]("msie-viewport-fix", Gt[w]("@-ms-viewport{width:device-width;}"), Z, 1))
            }
        };
    return Gt.preInit(), Gt[q][ot] < 9 && (Gt[At] = function(e) {}, Gt[w] = function(e) {
        var t;
        return t = document[C]("span"), t[qt] = '&nbsp;<style type="text/css">' + e + "</style>", t
    }), Gt
}();
